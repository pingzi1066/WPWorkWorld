...
namespace KMTool
{
    ...
    public abstract class KMTweener : MonoBehaviour
    {
        /// <summary>
        /// Current tween that triggered the callback function.
        /// </summary>

        static public KMTweener current;
        ...
        static public T Begin<T>(GameObject go, float duration, float delay = 0f) where T : KMTweener
        {
